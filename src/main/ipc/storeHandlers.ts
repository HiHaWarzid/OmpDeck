...
export function registerStoreHandlers(deps: StoreHandlerDeps) {
	...
	ipcMain.handle(
		...
		async (_event, item: PromptStoreItem, locationId: "pi-global" | "agents-global" = "pi-global") => {
			try {
