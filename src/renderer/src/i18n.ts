...
const zhCN = {
  ...
  "mem.card.organizePrompt": "请帮我整理记忆库，读取 ~/.omp/agent/memory-store.json，分析其中的记忆条目：清理重复、合并相近、删除临时状态信息。\n\n规则：\n1. 只输出分析报告，不要调用任何工具\n2. 不要提问，不要确认，直接输出报告\n3. 用户会根据你的报告在界面上自行操作",
  "mem.time.never": "从未",
  "mem.time.today": "今天",
  ...
  "app.startAgent": "开始一个 omp agent",
  "app.emptyTaglineNew": "A coding agent\nwith the IDE wired in.",
  "app.emptySubtitle": "The most capable agent surface that ships.\nContinuously tuned by real-world use — complete out of the box,\nunapologetically native. Windows-native, no WSL.",
  "app.terminal": "终端",
  ...
  "app.agentCreateTimeout": "Agent 启动超时，请检查 omp 是否能正常启动，或稍后重试。",
  "app.sessionRefreshTimeout": "会话列表刷新超时，请稍后重试。",
  "app.sessionLoadFailed": "会话历史加载失败",
  ...
  "app.composerEnterPlaceholder": "输入消息，Enter 发送。& 会话，@ 文件/目录，/ 命令，! shell",
  ...
  "app.composerShortcutPlaceholder": "输入消息，按设置的快捷键发送。& 会话，@ 文件/目录，/ 命令，! shell",
  ...
  "app.currentSessionCopied": "已通过 omp RPC 复制当前会话",
  ...
  "git.gitNotInstalledDesc": "源代码管理功能需要 Git。请前往 https://git-scm.com 安装 Git 后重启 OmpDeck。",
  ...
  "app.modelSetDefault": "设为默认（新会话初始模型）",
  "app.modelIsDefault": "已设为默认模型",
  "app.modelNoProvider": "该模型未关联供应商，无法设为默认",
  "app.modelSetDefaultSuccess": "已将 {name} 设为默认模型",
  "app.modelSetDefaultFailed": "设置默认模型失败，请检查 settings.json 是否可写",
  "app.moreAgents": "更多 {count} 个 Agent",
  "app.openTerminalTitle": "显示或隐藏当前上下文的终端",
  "app.piCheckFailed": "omp 检测失败：{error}",
  "app.piCheckPassed": "omp 检测通过：{value}",
  "app.piPathCleared": "已清除自定义 omp 路径，将恢复自动检测。",
  "app.piPathSaved": "omp 路径已保存：{path}",
  "app.piPathValidateFailed": "omp 路径校验失败：{error}",
  "app.preloadMissing": "桌面端预加载 API 未注入，请重新启动 OmpDeck。",
  ...
  "app.projectSessionsLoadFailed": "历史会话加载失败",
  ...
  "app.proxyChecking": "正在检测 omp agent 代理...",
  ...
  "app.send": "发送",
  "app.attachFile": "文件引用",
  "app.askPendingTitle": "Agent 正在向你提问",
  "app.askNotificationTitle": "{app} · 提问",
  "app.askNotificationBody": "{title}",
  ...
  "app.promptTemplateEmptyBody": "模板「{name}」正文为空，请先补充内容后再发送。",
  ...
  "app.sessionCopied": "已通过 omp RPC 复制会话",
  ...
  "todo.statusInProgress": "进行中",
  "todo.statusPending": "待处理",
  "todo.statusCompleted": "已完成",
  "app.shellProxyDisabled": "omp agent 代理已关闭。",
  "app.shellProxySaved": "omp agent 代理设置已保存；新建或重启 agent 后生效。",
  "app.stop": "停止",
  "app.statusIdle": "空闲",
  ...
  "app.electronSandboxSaved": "Electron 沙箱设置已保存，重启 OmpDeck 后生效。",
  "app.singleInstanceSaved": "单实例设置已保存，重启 OmpDeck 后生效。",
  ...
  "app.windowControls": "OmpDeck 窗口控制",
  ...
  "agent.trust.message": "此项目包含 omp 配置资源（扩展、skills、设置等）。信任后 omp 将加载并执行这些项目级资源，请确认你信任该项目来源。",
  ...
  "config.providerGuideCompatDevRole": "服务器不支持 developer 角色时设为 false，omp 将使用 system 角色代替",
  ...
  "config.providerGuideNote": "完整的参数说明和示例请参考 omp 官方文档",
  ...
  "config.authGuideDesc": "认证配置用于存储 API Key，omp 会自动从 ~/.omp/agent/auth.json 读取。",
  ...
  "config.authGuideStep3": "保存 → omp 启动时自动加载 auth.json 中的认证信息",
  ...
  "config.fetchModelsHintAnthropic": "Anthropic Messages API 不支持 /models 端点。请手动添加 Claude 模型 ID（如 claude-sonnet-4-20250514、claude-3.5-haiku），或查看 omp 官方文档获取完整模型列表。",
  ...
  "config.modelsMirrorFailed": "已保存 models.json，但同步 OMP 的 models.yml 失败（{detail}）。pi 侧仍在用旧配置，请重试保存。",
  "config.saved": "配置已保存",
  "config.ompDefaultTitle": "OMP 默认",
  "config.ompDefaultActive": "当前 OMP 默认",
  "config.ompDefaultInactive": "未设为默认",
  "config.ompDefaultModelLabel": "默认模型",
  "config.ompDefaultModelPlaceholder": "选择该供应商的模型",
  "config.ompDefaultThinkingLabel": "默认思考等级",
  "config.ompDefaultThinkingPlaceholder": "选择思考等级",
  "config.ompDefaultThinkingUnset": "跟随 omp 自身默认（不设置）",
  "config.ompDefaultThinkingAuto": "auto（自动）",
  "config.ompDefaultSet": "设为 OMP 默认",
  "config.ompDefaultClear": "取消默认",
  "config.ompDefaultSetToast": "已设为默认：{model}（{provider}），新会话生效",
  "config.ompDefaultCleared": "已取消 OMP 默认设置",
  ...
  "config.retry.hint": "只配置 omp Agent 外层重试次数和基础延迟，通过指数退避处理供应商请求失败。修改后需重启 Agent 生效。",
  "config.retry.maxRetries": "最大重试次数",
  "config.retry.baseDelayMs": "基础延迟 (ms)",
  "config.compaction.title": "会话压缩",
  "config.compaction.hint": "写入 ~/.omp/agent/settings.json 的 compaction。自动压缩在上下文接近上限时触发；修改后需重启 Agent 生效。",
  ...
  "config.label.theme": "主题 (omp)",
  "config.label.language": "语言 (omp)",
  ...
  "config.sessionDir.hint": "仅配置全局 ~/.omp/agent/settings.json 的 sessionDir。相对路径相对项目 cwd（如 .omp/sessions）；留空则使用默认 ~/.omp/agent/sessions/。项目级请改对应项目的 .omp/settings.json。",
  "config.sessionDir.placeholder": "例如 .omp/sessions 或 ~/my-sessions",
  ...
  "config.developerRoleDesc": "API 不支持 developer role 时关闭，omp 将改用 system role 发送系统提示。",
  ...
  "editor.truncatedNotice": "文件过大，仅加载了开头部分（其余内容未读取）",
  "editor.preview": "预览",
  "editor.source": "源码",
  "editors.clear": "清除",
  "editors.browse": "浏览",
  ...
  "projectResources.emptyPrompts": "该项目暂无项目级提示词。.omp/prompts/ 下的 .md 文件将显示在这里。",
  "projectResources.createSkill": "新建项目 Skill",
  "projectResources.createSkillHint": "Skill 会创建到 .omp/skills/ 下，描述已写入 SKILL.md 的 frontmatter。创建后编辑 SKILL.md 在 ## Usage 下添加具体指令。",
  "projectResources.emptySkills": "该项目暂无 Skill。在上方输入名称和描述后点击添加。",
  "projectResources.emptyExtensions": "该项目暂无 Extension。文件应放在 .omp/extensions/ 下。",
  ...
  "projectResources.extensionsHint": "项目扩展放在 .omp/extensions/ 目录下（.ts 文件或含 index.ts 的子目录）。",
  ...
  "config.headerEmptyHint": "留空时不写入 headers，使用 omp / SDK 运行时默认值",
  "config.location": "位置",
  "config.model": "模型",
  ...
  "config.xhigh": "xhigh",
  "config.xhighOff": "关闭",
  "config.xhighDesc": "声明该模型支持 omp 的 xhigh 档位，并选择发送给上游的 reasoning_effort 值。选择后会自动开启推理和 provider 的 reasoning_effort。",
  "config.inputType": "输入",
  ...
  "config.skillDescriptionMissing": "缺少 description，omp 不会加载该 skill。",
  "config.builtin": "内置",
  ...
  "config.create": "创建",
  "config.noPrompts": "暂无 Prompt 模板。创建后在 omp 中输入 /<名称> 快速使用。",
  ...
  "config.uninstallExtensionBody": "确认卸载「{source}」吗？这会执行 omp remove 并从 omp 配置中移除该扩展。",
  ...
  "config.im.requireMention": "群聊需 @ 才回复",
  "config.im.requireMentionDesc": "关闭后群聊直接发消息也可触发；单聊始终免 @",
  ...
  "config.im.guideMethodAStep3": "在 OmpDeck 填入配置，点击保存后连接",
  ...
  "config.im.guideMethodBStep6": "在「凭证与基础信息」中获取 App ID 和 App Secret，填入 OmpDeck",
  ...
  "environment.title": "omp 环境检测",
  "environment.checking": "正在检测 omp CLI…",
  "environment.passed": "检测通过",
  "environment.path": "路径",
  "environment.version": "版本",
  "environment.autoClose": "窗口将在 3 秒后自动关闭。",
  "environment.notFoundTitle": "未检测到 omp CLI",
  "environment.notFoundDesc": "桌面端通过系统 PATH 和常见包管理器路径自动查找 omp 命令。如果 omp 已安装但未被检测到，可以通过下方参考命令在终端中找到路径后手动指定。",
  "environment.errorDetails": "检测错误详情",
  "environment.installTitle": "还没安装 omp？",
  "environment.installDesc": "请按 omp 官方 quickstart 安装并配置 CLI，安装后重新打开应用或点击下方重新检测。",
  "environment.openInstallDocs": "打开安装文档",
  "environment.commandLabel": "命令",
  "environment.customPathTitle": "手动指定 omp 路径",
  "environment.customPathDesc": "如果 omp 已安装但桌面端检测不到（如使用了 nvm、pnpm 全局安装、或自定义 mise 数据目录），可运行下方命令，将输出的 omp.cmd 或 omp.exe 路径粘贴到输入框中。",
  ...
  "environment.clearCheckFlagHint": "重置 omp 环境检测标记，下次启动时重新触发检测",
  "environment.checkFlagCleared": "已重置 omp 环境检测标记，重启后将重新检测",
  "environment.stepCli": "检测 CLI",
  "environment.stepInstall": "安装 omp",
  "environment.stepPath": "确认路径",
  "environment.stepPermission": "验证权限",
  "environment.stepDone": "完成",
  "environment.installCardTitle": "通过 npm 安装 omp",
  "environment.installCardDesc": "如果尚未安装 omp，可以在终端逐行执行以下命令安装 Node.js 和 omp CLI（已安装 Node.js 可跳过第一步）。安装完成后重新打开应用。",
  ...
  "environment.installSuccess": "omp CLI 安装成功！请重启应用以生效。",
  ...
  "environment.installRestartHint": "重启后 omp 环境检测将会再次运行。",
  ...
  "feedback.descriptionPlaceholder": "例如：点击检测环境后提示未检测到 omp，但命令行里 omp --version 正常。",
  ...
  "feedback.report.piDesktop": "- OmpDeck: {value}",
  ...
  "feedback.report.piStatus": "- omp 检测: {value}",
  "feedback.report.piCommand": "- omp 命令: {value}",
  "feedback.report.piVersion": "- omp 版本: {value}",
  "feedback.report.piError": "- omp 错误: {value}",
  ...
  "drawer.sessionDegraded": "此会话文件部分损坏，消息数与预览可能不完整",
  ...
  "prompt.command.settings.description": "打开 omp 设置",
  ...
  "settings.tabs.roles": "模型角色",
  "settings.modelRoles.section": "模型角色",
  "settings.modelRoles.sectionDesc": "给 omp 的每个模型角色（modelRoles）指定模型：主对话、快速、深度思考、看图、规划、提交信息、微型、子任务、顾问。改动写入 ~/.omp/agent/config.yml，新会话生效。",
  "settings.modelRoles.loading": "正在读取模型角色…",
  "settings.modelRoles.loadError": "读取模型角色失败",
  "settings.modelRoles.unset": "未设置",
  "settings.modelRoles.set": "设置",
  "settings.modelRoles.change": "更换",
  "settings.modelRoles.clear": "清除",
  "settings.modelRoles.saved": "{role} 已更新，重启会话后生效。",
  "settings.modelRoles.cleared": "{role} 已清除，重启会话后生效。",
  "settings.modelRoles.saveFailed": "保存失败",
  "settings.modelRoles.pickerSearch": "搜索模型或服务商…",
  "settings.modelRoles.pickerEmpty": "没有匹配的模型",
  "settings.role.default.name": "Default 主对话",
  "settings.role.default.desc": "会话主模型（modelRoles.default）",
  "settings.role.smol.name": "Fast 快速",
  "settings.role.smol.desc": "轻量任务用的快/便宜模型",
  "settings.role.slow.name": "Thinking 深度思考",
  "settings.role.slow.desc": "需要深度推理的长任务模型",
  "settings.role.vision.name": "Vision 看图",
  "settings.role.vision.desc": "文本模型收到图片时负责描述的视觉模型",
  "settings.role.plan.name": "Architect 规划",
  "settings.role.plan.desc": "架构规划/设计阶段的模型",
  "settings.role.commit.name": "Commit 提交信息",
  "settings.role.commit.desc": "生成 git 提交信息的模型",
  "settings.role.tiny.name": "Tiny 微型",
  "settings.role.tiny.desc": "在线轻量微型模型（TINY 角色）",
  "settings.role.task.name": "Subtask 子任务",
  "settings.role.task.desc": "子任务/并行分支使用的模型",
  "settings.role.advisor.name": "Advisor 顾问",
  "settings.role.advisor.desc": "复盘/咨询场景的顾问模型",
  ...
  "settings.startupWindowModeDesc": "下次启动时应用。默认恢复上次窗口大小；首次启动或记录缺失时顺延最大化。",
  ...
  "settings.piUpdate": "omp CLI 更新",
  "settings.piUpdateDesc": "先检测当前与最新版本，有新版本时才执行更新。",
  "settings.checkPiUpdate": "检查 omp 更新",
  "settings.piUpdateVersions": "当前：{current} · 最新：{latest}",
  "settings.updatePi": "更新 omp",
  "settings.piUpdateDone": "omp 更新命令已完成",
  "settings.piUpdateChecked": "omp 已是最新版本",
  "settings.piUpdateAvailable": "发现 omp 新版本",
  "settings.piUpdateStartupNotice": "检测到 omp 不是最新版本，部分功能可能与低版本不兼容。请到设置里手动更新 omp。",
  "settings.piUpdateFailed": "omp 更新失败：{error}",
  "settings.disableUpdateCheck": "禁用版本检测",
  "settings.disableUpdateCheckDesc": "开启后不再自动检测 OmpDeck 和 omp CLI 的版本更新，设置页中检测按钮也将禁用。",
  "settings.electronSandbox": "启用 Chromium 沙箱",
  "settings.electronSandboxDesc": "控制 Electron 渲染进程沙箱（与 omp Agent 无关）。默认关闭以兼容 Windows 安全软件/旧 GPU 驱动；开启后需重启 OmpDeck。若启动异常请改回关闭。",
  "settings.piRpcStartup": "Agent 启动诊断",
  "settings.piRpcStartupDesc": "影响 omp --mode rpc 的启动参数。改完后需重新启动 Agent 才会生效。",
  "settings.piRpcOffline": "RPC 离线启动 (--offline)",
  "settings.piRpcOfflineDesc": "跳过 omp 启动时的模型目录网络刷新。桌面端模型列表来自本地 models.json，建议保持开启以加快冷启动。",
  ...
  "settings.extensionsUpdating": "正在执行 omp update --extensions --no-approve...",
  "settings.extensionsUpdatingDesc": "更新期间请保持窗口打开，完成后可查看完整输出。",
  "settings.extensionsUpdateResultHint": "已保留 omp CLI 返回的完整输出；如果只显示 Updated packages，说明 CLI 未提供逐项详情，可关闭后刷新确认。",
  ...
  "settings.customPiPath": "自定义 omp 路径",
  ...
  "settings.enablePiProxy": "启用 omp agent 代理",
  ...
  "settings.piCliAvailable": "检查 omp CLI 是否可用",
  "settings.piSection": "omp 环境",
  "settings.piSectionDesc": "检测 omp CLI 是否可用，配置自定义路径",
  "settings.piVersion": "omp 版本",
  "settings.notDetected": "未检测到 omp CLI",
  "settings.checkPi": "检测 omp",
  "settings.customPiPathDesc": "支持带引号、双反斜杠和无扩展名路径；保存前会自动归一化并校验。",
  "settings.piSource.label": "omp 来源",
  "settings.piSource.desc": "选择使用 Windows 本地安装的 omp，还是 WSL 发行版中的 omp。",
  "settings.piSource.windows": "Windows — 使用本地 omp",
  "settings.piSource.wsl": "WSL — 使用 WSL 发行版中的 omp",
  ...
  "settings.wsl.piDetected": "omp CLI 已安装：{version}",
  "settings.wsl.piNotInstalled": "omp CLI 未安装，请在 WSL 中运行 npm i -g @earendil-works/pi",
  "settings.piUpdateSection": "omp CLI 更新",
  "settings.piUpdateSectionDesc": "先检测当前与最新版本，有新版本时才执行更新。",
  "settings.piUpToDate": "已是最新",
  "settings.piUpdateTo": "可更新至 {latest}",
  "settings.piUpdateSuccess": "omp 更新成功",
  ...
  "settings.piEnvironment": "omp 环境",
  "settings.piMissing": "未检测到 omp CLI",
  "settings.piProxy": "omp agent 代理",
  "settings.piProxyDesc": "只注入给新启动的 omp agent 子进程",
  "settings.privacy": "隐私",
  ...
  "settings.testPiProxy": "检测 omp agent 代理",
  ...
  "tool.showFullOutput": "查看完整输出",
  "tool.loadingFullOutput": "加载中…",
  "tool.fullOutputFailed": "加载失败，请重试",
  "tool.fullOutputLoaded": "已加载全文",
  ...
  "update.checkFailedDescription": "无法连接 GitHub Release。国内网络环境下 GitHub 可能不可达，你可以稍后重试，或在设置的代理设置里配置桌面端代理后再次检查。",
  ...
  "afk.title": "AFK 编排",
  "afk.openCenter": "打开 AFK 中心",
  "afk.enabled": "启用 AFK",
  "afk.enabledDesc": "自动认领 ready-for-agent 工单并派发 agent 到隔离 worktree",
  "afk.targetProject": "目标项目",
  "afk.targetProjectPlaceholder": "选择工单来源项目",
  "afk.pollInterval": "轮询间隔（秒）",
  "afk.timeout": "任务超时（分钟）",
  "afk.goConfigure": "去配置",
  "afk.configureHint": "AFK 尚未配置，请先在设置中指定目标项目",
  "afk.tabs.overview": "总览",
  "afk.tabs.tasks": "任务",
  "afk.tabs.prs": "PR 待合并",
  "afk.stats.active": "活跃",
  "afk.stats.complete": "完成",
  "afk.stats.failed": "失败",
  "afk.stats.prPending": "待合并",
  "afk.lastPollAt": "最后轮询",
  "afk.neverPolled": "尚未轮询",
  "afk.status.queued": "排队",
  "afk.status.running": "运行中",
  "afk.status.complete": "完成",
  "afk.status.failed": "失败",
  "afk.status.pr-pending": "待合并",
  "afk.status.needs-review": "待评审",
  "afk.tasks.empty": "暂无任务",
  "afk.overview.empty": "轮询等待 ready-for-agent 工单…",
  "afk.task.branch": "分支",
  "afk.task.duration": "耗时",
  "afk.task.error": "错误",
  "afk.task.pr": "PR",
  "afk.detail.timeline": "时间线",
  "afk.detail.openTicket": "打开工单",
  "afk.detail.openSession": "打开会话",
  "afk.detail.openPr": "打开 PR",
  "afk.detail.terminate": "终止",
  "afk.detail.openWorktree": "打开目录",
  "afk.timeline.created": "已认领",
  "afk.timeline.worktree": "已建 worktree",
  "afk.timeline.running": "agent 已启动",
  "afk.timeline.complete": "完成（PR 已开）",
  "afk.timeline.failed": "失败",
  "afk.timeline.prCreated": "PR 已创建",
  "afk.prs.empty": "暂无待合并 PR",
...
const enUS: Record<TranslationKey, string> = {
  ...
  "mem.card.organizePrompt": "Please help organize the memory store. Read ~/.omp/agent/memory-store.json and analyze its entries: remove duplicates, merge similar items, and drop temporary status notes.\n\nRules:\n1. Output an analysis report only; do not call any tools\n2. Do not ask questions or request confirmation; output the report directly\n3. The user will act on your report in the UI",
  ...
  "app.worktreeRemoveNotFound": "Git worktree not found. It may have been removed outside OmpDeck.",
  ...
  "app.startAgent": "Start an omp agent",
  "app.emptyTaglineNew": "A coding agent\nwith the IDE wired in.",
  "app.emptySubtitle": "The most capable agent surface that ships.\nContinuously tuned by real-world use — complete out of the box,\nunapologetically native. Windows-native, no WSL.",
  ...
  "app.composerEnterPlaceholder": "Type a message. Enter sends. & sessions, @ files/folders, / commands, ! shell",
  ...
  "app.composerShortcutPlaceholder": "Type a message. Use your shortcut to send. & sessions, @ files/folders, / commands, ! shell",
  ...
  "app.currentSessionCopied": "Current session copied through omp RPC",
  ...
  "git.gitNotInstalledDesc": "Source control management requires Git. Please install Git from https://git-scm.com and restart OmpDeck.",
  ...
  "app.modelSetDefault": "Set as default (initial model for new sessions)",
  "app.modelIsDefault": "Default model",
  "app.modelNoProvider": "No provider associated; cannot set as default",
  "app.modelSetDefaultSuccess": "{name} set as default model",
  "app.modelSetDefaultFailed": "Failed to set default model. Check whether settings.json is writable.",
  "app.moreAgents": "{count} more Agents",
  "app.agentCreateTimeout": "Agent startup timed out. Check whether omp can start normally, then try again.",
  "app.sessionRefreshTimeout": "Session list refresh timed out. Try again shortly.",
  "app.sessionLoadFailed": "Failed to load session history",
  "app.openTerminalTitle": "Show or hide the terminal for the current context",
  "app.piCheckFailed": "omp check failed: {error}",
  "app.piCheckPassed": "omp check passed: {value}",
  "app.piPathCleared": "Custom omp path cleared. Automatic detection will be used.",
  "app.piPathSaved": "omp path saved: {path}",
  "app.piPathValidateFailed": "omp path validation failed: {error}",
  "app.preloadMissing": "Desktop preload API is not available. Restart OmpDeck.",
  ...
  "app.projectSessionsLoadFailed": "Failed to load history sessions",
  ...
  "app.proxyChecking": "Checking omp agent proxy...",
  ...
  "app.askPendingTitle": "Agent is asking you a question",
  "app.askNotificationTitle": "{app} · Question",
  "app.askNotificationBody": "{title}",
  ...
  "app.promptTemplateEmptyBody": "Template \"{name}\" has no body yet. Add content before sending.",
  ...
  "app.sessionCopied": "Session copied through omp RPC",
  ...
  "todo.statusCompleted": "Completed",
  "app.shellProxyDisabled": "omp agent proxy disabled.",
  "app.shellProxySaved": "omp agent proxy saved. Create or restart agents for it to take effect.",
  "app.stop": "Stop",
  "app.statusIdle": "Idle",
  ...
  "app.electronSandboxSaved": "Electron sandbox setting saved. Restart OmpDeck to apply it.",
  "app.singleInstanceSaved": "Single-instance setting saved. Restart OmpDeck to apply it.",
  ...
  "app.windowControls": "OmpDeck window controls",
  ...
  "agent.trust.message": "This project contains omp configuration resources (extensions, skills, settings, etc.). Once trusted, omp will load and execute these project-local resources. Make sure you trust this project's source.",
  ...
  "config.providerGuideCompatDevRole": "Set to false when the server does not support developer role; omp will use system role instead",
  ...
  "config.providerGuideNote": "For full parameter details and examples, see omp official docs",
  ...
  "config.authGuideDesc": "Auth config stores API keys. omp loads them automatically from ~/.omp/agent/auth.json.",
  ...
  "config.authGuideStep3": "Save → omp loads auth.json credentials automatically on startup",
  ...
  "config.fetchModelsHintAnthropic": "Anthropic Messages API does not support the /models endpoint. Please manually add Claude model IDs (e.g. claude-sonnet-4-20250514, claude-3.5-haiku), or check the omp documentation for the full model list.",
  ...
  "config.loadFailed": "omp Management failed to load",
  ...
  "config.renderCrashed": "omp Management render error",
  ...
  "config.modelsMirrorFailed": "models.json was saved, but syncing OMP's models.yml failed ({detail}). pi still uses the previous config — please save again.",
  "config.saved": "Configuration saved",
  "config.ompDefaultTitle": "OMP Default",
  "config.ompDefaultActive": "Current OMP default",
  "config.ompDefaultInactive": "Not the default",
  "config.ompDefaultModelLabel": "Default model",
  "config.ompDefaultModelPlaceholder": "Pick a model from this provider",
  "config.ompDefaultThinkingLabel": "Default thinking level",
  "config.ompDefaultThinkingPlaceholder": "Pick a thinking level",
  "config.ompDefaultThinkingUnset": "Follow omp's own default (unset)",
  "config.ompDefaultThinkingAuto": "auto",
  "config.ompDefaultSet": "Set as OMP default",
  "config.ompDefaultClear": "Clear default",
  "config.ompDefaultSetToast": "Default set: {model} ({provider}). Applies to new sessions",
  "config.ompDefaultCleared": "OMP default cleared",
  ...
  "config.retry.hint": "Only configures omp Agent-level retry count and base delay with exponential backoff for provider request failures. Restart the Agent for changes to take effect.",
  "config.retry.maxRetries": "Max Retries",
  "config.retry.baseDelayMs": "Base Delay (ms)",
  "config.compaction.title": "Session Compaction",
  "config.compaction.hint": "Writes the compaction block in ~/.omp/agent/settings.json. Auto-compaction runs when context nears the window limit. Restart the Agent for changes to take effect.",
  ...
  "config.label.theme": "Theme (omp)",
  "config.label.language": "Language (omp)",
  ...
  "config.sessionDir.hint": "Edits only the global sessionDir in ~/.omp/agent/settings.json. Relative paths resolve against the project cwd (e.g. .omp/sessions). Leave empty for the default ~/.omp/agent/sessions/. For a single project, set .omp/settings.json in that project instead.",
  "config.sessionDir.placeholder": "e.g. .omp/sessions or ~/my-sessions",
  ...
  "config.developerRoleDesc": "Disable when the API does not support developer role; omp will use system role instead.",
  ...
  "editor.truncatedNotice": "File is very large; only the beginning was loaded",
  ...
  "editors.hint": "Manage external editors shown in the project menu. OmpDeck detects them asynchronously on first launch, and paths can be edited manually.",
  ...
  "projectResources.emptyPrompts": "No project-level prompts yet. .md files in .omp/prompts/ will appear here.",
  "projectResources.createSkill": "New Project Skill",
  "projectResources.createSkillHint": "The skill will be created under .omp/skills/. The description is saved to the SKILL.md frontmatter. After creation, edit SKILL.md to add your instructions under ## Usage.",
  "projectResources.emptySkills": "No project skills yet. Enter a name and description above to add one.",
  "projectResources.emptyExtensions": "No project extensions yet. Place files under .omp/extensions/.",
  ...
  "projectResources.extensionsHint": "Project extensions live under .omp/extensions/ (.ts files or directories with index.ts).",
  ...
  "config.field.userAgent": "User-Agent",
  "config.headerEmptyHint": "Leave empty to omit headers and use the omp / SDK runtime default.",
  ...
  "config.xhigh": "xhigh",
  "config.xhighOff": "Off",
  "config.xhighDesc": "Declare that this model supports omp's xhigh level and choose the reasoning_effort value sent upstream. Selecting a value also enables reasoning and provider reasoning_effort.",
  ...
  "config.skillDescriptionMissing": "Missing description. omp will not load this skill.",
  ...
  "config.noPrompts": "No prompt templates. After creation, type /<name> in omp to use them.",
  "config.promptNamePlaceholder": "review",
  ...
  "config.uninstallExtensionBody":
    'Uninstall "{source}"? This runs omp remove and removes the extension from omp config.',
  ...
  "config.im.requireMention": "Require @ in group chats",
  "config.im.requireMentionDesc": "When off, group-chat messages reply without @; p2p chats never require @",
  ...
  "config.im.guideMethodAStep3": "Fill in the credentials in OmpDeck and connect",
  ...
  "config.im.guideMethodBStep6": "Get App ID and App Secret from 'Credentials & Basic Info', fill in OmpDeck",
  ...
  "environment.title": "omp Environment Check",
  "environment.checking": "Checking omp CLI...",
  "environment.passed": "Check passed",
  "environment.path": "Path",
  "environment.version": "Version",
  "environment.autoClose": "This window will close automatically in 3 seconds.",
  "environment.notFoundTitle": "omp CLI not found",
  "environment.notFoundDesc": "The desktop app searches system PATH and common package manager paths for the omp command. If omp is installed but not detected, use the command below to find the path and set it manually.",
  "environment.errorDetails": "Detection error details",
  "environment.installTitle": "omp not installed yet?",
  "environment.installDesc": "Follow the official omp quickstart to install and configure the CLI, then reopen the app or run the check again.",
  "environment.openInstallDocs": "Open install docs",
  "environment.commandLabel": "Command",
  "environment.customPathTitle": "Set omp path manually",
  "environment.customPathDesc": "If omp is installed but not detected, for example through nvm, pnpm global installs, or a custom mise data directory, run the command below and paste the omp.cmd or omp.exe path here.",
  ...
  "environment.clearCheckFlagHint": "Reset omp environment check flag to re-trigger detection on next startup",
  "environment.checkFlagCleared": "omp check flag cleared. Detection will run again on restart.",
  "environment.stepCli": "Check CLI",
  "environment.stepInstall": "Install omp",
  "environment.stepPath": "Confirm path",
  "environment.stepPermission": "Validate access",
  "environment.stepDone": "Done",
  "environment.installCardTitle": "Install omp via npm",
  "environment.installCardDesc": "If omp is not installed yet, you can run the commands below in your terminal. Skip the first step if you already have Node.js installed. Restart the app after installation completes.",
  ...
  "environment.installSuccess": "omp CLI installed successfully! Please restart the app.",
  ...
  "environment.installRestartHint": "After restart, the omp environment check will run again.",
  ...
  "feedback.intro": "Describe the issue, then copy the report or open a GitHub Issue. You can also email",
  "feedback.descriptionLabel": "Issue",
  "feedback.descriptionHint": "Describe the issue or feature request",
  "feedback.descriptionPlaceholder": "For example: Environment check says omp was not found, but omp --version works in the terminal.",
  "feedback.stepsLabel": "Steps to reproduce",
  "feedback.stepsHint": "Write reproducible steps (optional)",
  "feedback.stepsPlaceholder": "1. Open the app\n2. Click Feedback in omp Management\n3. ...",
  ...
  "feedback.report.piStatus": "- omp check: {value}",
  "feedback.report.piCommand": "- omp command: {value}",
  "feedback.report.piVersion": "- omp version: {value}",
  "feedback.report.piError": "- omp error: {value}",
  ...
  "drawer.sessionMessages": "{count} messages",
  "drawer.sessionDegraded": "This session file is partially corrupted; message count and preview may be incomplete",
  "drawer.sessionCount": "{count} sessions",
  ...
  "prompt.command.compact.description": "Compact context (desktop built-in; optional custom instructions)",
  ...
  "prompt.command.settings.description": "Open omp settings",
  ...
  "settings.tabs.roles": "Model Roles",
  "settings.modelRoles.section": "Model Roles",
  "settings.modelRoles.sectionDesc": "Assign a model to each omp role (modelRoles): main conversation, fast, deep thinking, vision, planning, commit message, tiny, subtask, advisor. Writes to ~/.omp/agent/config.yml; takes effect in new sessions.",
  "settings.modelRoles.loading": "Loading model roles…",
  "settings.modelRoles.loadError": "Failed to load model roles",
  "settings.modelRoles.unset": "Unset",
  "settings.modelRoles.set": "Set",
  "settings.modelRoles.change": "Change",
  "settings.modelRoles.clear": "Clear",
  "settings.modelRoles.saved": "{role} updated. Restart the session to apply.",
  "settings.modelRoles.cleared": "{role} cleared. Restart the session to apply.",
  "settings.modelRoles.saveFailed": "Save failed",
  "settings.modelRoles.pickerSearch": "Search models or providers…",
  "settings.modelRoles.pickerEmpty": "No matching models",
  "settings.role.default.name": "Default",
  "settings.role.default.desc": "Main conversation model (modelRoles.default)",
  "settings.role.smol.name": "Fast",
  "settings.role.smol.desc": "Fast/cheap model for lightweight tasks",
  "settings.role.slow.name": "Thinking",
  "settings.role.slow.desc": "Model for long tasks needing deep reasoning",
  "settings.role.vision.name": "Vision",
  "settings.role.vision.desc": "Vision model used to describe images for text models",
  "settings.role.plan.name": "Architect",
  "settings.role.plan.desc": "Model for architecture planning/design phases",
  "settings.role.commit.name": "Commit",
  "settings.role.commit.desc": "Model that writes git commit messages",
  "settings.role.tiny.name": "Tiny",
  "settings.role.tiny.desc": "Online lightweight tiny model (TINY role)",
  "settings.role.task.name": "Subtask",
  "settings.role.task.desc": "Model used for subtasks / parallel branches",
  "settings.role.advisor.name": "Advisor",
  "settings.role.advisor.desc": "Advisor model for review/advisory sessions",
  ...
  "settings.clearCustomPiPath": "Clear",
  ...
  "settings.startupWindowModeDesc": "Applied on next launch. Default restores the last window size; falls back to maximized on first launch or missing record.",
  ...
  "settings.piUpdate": "omp CLI Update",
  "settings.piUpdateDesc": "Check current/latest versions first, then update only when a newer version exists.",
  "settings.checkPiUpdate": "Check omp Update",
  "settings.piUpdateVersions": "Current: {current} · Latest: {latest}",
  "settings.updatePi": "Update omp",
  "settings.piUpdateDone": "omp update command completed",
  "settings.piUpdateChecked": "omp is already up to date",
  "settings.piUpdateAvailable": "New omp version available",
  "settings.piUpdateStartupNotice": "omp is not up to date. Some features may be incompatible with older versions. Please update omp manually in Settings.",
  "settings.piUpdateFailed": "omp update failed: {error}",
  "settings.disableUpdateCheck": "Disable Update Check",
  "settings.disableUpdateCheckDesc": "When enabled, stops auto-checking updates for OmpDeck and omp CLI. Update buttons in settings will also be disabled.",
  "settings.electronSandbox": "Enable Chromium sandbox",
  "settings.electronSandboxDesc": "Controls Electron renderer sandbox (unrelated to omp Agent). Off by default for Windows AV/GPU compatibility. Requires restarting OmpDeck. Turn it back off if the app fails to start.",
  "settings.piRpcStartup": "Agent startup diagnostics",
  "settings.piRpcStartupDesc": "Affects omp --mode rpc launch flags. Restart the Agent after changing these.",
  "settings.piRpcOffline": "RPC offline startup (--offline)",
  "settings.piRpcOfflineDesc": "Skip model-catalog network refresh during omp startup. Desktop models come from local models.json; keep enabled for faster cold start.",
  ...
  "settings.extensionsUpdating": "Running omp update --extensions --no-approve...",
  "settings.extensionsUpdatingDesc": "Keep this window open during update. Full output appears here after completion.",
  "settings.extensionsUpdateResultHint": "Full omp CLI output is preserved. If it only says Updated packages, the CLI did not return per-package details; close and refresh to confirm.",
  ...
  "settings.customPiPath": "Custom omp path",
  ...
  "settings.enablePiProxy": "Enable omp agent proxy",
  ...
  "settings.piCliAvailable": "Check whether omp CLI is available",
  "settings.piSection": "omp Environment",
  "settings.piSectionDesc": "Check whether omp CLI is available and configure custom path",
  "settings.piVersion": "omp Version",
  "settings.notDetected": "omp CLI not found",
  "settings.checkPi": "Check omp",
  ...
  "settings.piSource.label": "omp source",
  "settings.piSource.desc": "Choose to use omp from Windows or from a WSL distribution.",
  "settings.piSource.windows": "Windows — use local omp",
  "settings.piSource.wsl": "WSL — use omp from WSL distro",
  ...
  "settings.wsl.piDetected": "omp CLI installed: {version}",
  "settings.wsl.piNotInstalled": "omp CLI not installed, run npm i -g @earendil-works/pi in WSL",
  "settings.piUpdateSection": "omp CLI Update",
  "settings.piUpdateSectionDesc": "Check current/latest versions first, then update only when a newer version exists.",
  "settings.piUpToDate": "Up to date",
  "settings.piUpdateTo": "Update available: {latest}",
  "settings.piUpdateSuccess": "omp updated successfully",
  ...
  "settings.piEnvironment": "omp environment",
  "settings.piMissing": "omp CLI not found",
  "settings.piProxy": "omp agent proxy",
  "settings.piProxyDesc": "Injected only into newly started omp agent child processes",
  ...
  "settings.testPiProxy": "Test omp agent proxy",
  ...
  "settings.restartApp": "Restart OmpDeck",
  ...
  "settings.restartNotice": "Title bar changes take effect after restarting OmpDeck.",
  ...
  "settings.validatePiPath": "Validate",
  ...
  "tool.loadingFullOutput": "Loading…",
  "tool.fullOutputFailed": "Failed to load, try again",
  "tool.fullOutputLoaded": "Full text loaded",
  ...
  "update.checkFailedDescription": "Could not connect to GitHub Releases. GitHub may be unreachable on this network. Try again later, or configure the desktop proxy in Settings and check again.",
  ...
  "update.manualReleaseHint": "You can also open the Release page in your browser to check and download manually:",
  ...
  "afk.title": "AFK Orchestration",
  "afk.openCenter": "Open AFK Center",
  "afk.enabled": "Enable AFK",
  "afk.enabledDesc": "Automatically claim ready-for-agent tickets and dispatch agents into isolated worktrees",
  "afk.targetProject": "Target project",
  "afk.targetProjectPlaceholder": "Select the project that supplies tickets",
  "afk.pollInterval": "Poll interval (s)",
  "afk.timeout": "Task timeout (min)",
  "afk.goConfigure": "Configure",
  "afk.configureHint": "AFK is not configured — pick a target project in Settings",
  "afk.tabs.overview": "Overview",
  "afk.tabs.tasks": "Tasks",
  "afk.tabs.prs": "PRs awaiting merge",
  "afk.stats.active": "Active",
  "afk.stats.complete": "Completed",
  "afk.stats.failed": "Failed",
  "afk.stats.prPending": "Awaiting merge",
  "afk.lastPollAt": "Last poll",
  "afk.neverPolled": "Never polled",
  "afk.status.queued": "Queued",
  "afk.status.running": "Running",
  "afk.status.complete": "Completed",
  "afk.status.failed": "Failed",
  "afk.status.pr-pending": "Awaiting merge",
  "afk.status.needs-review": "Needs review",
  "afk.tasks.empty": "No tasks yet",
  "afk.overview.empty": "Polling for ready-for-agent tickets…",
  "afk.task.branch": "Branch",
  "afk.task.duration": "Duration",
  "afk.task.error": "Error",
  "afk.task.pr": "PR",
  "afk.detail.timeline": "Timeline",
  "afk.detail.openTicket": "Open ticket",
  "afk.detail.openSession": "Open session",
  "afk.detail.openPr": "Open PR",
  "afk.detail.terminate": "Terminate",
  "afk.detail.openWorktree": "Open worktree",
  "afk.timeline.created": "Claimed",
  "afk.timeline.worktree": "Worktree created",
  "afk.timeline.running": "Agent started",
  "afk.timeline.complete": "Completed (PR opened)",
  "afk.timeline.failed": "Failed",
  "afk.timeline.prCreated": "PR created",
  "afk.prs.empty": "No PRs awaiting merge",
