...
"config.emptyExtensions": "暂无已安装扩展。",
  ...
  "config.recommendedPackagesHint": "以下扩展与 OmpDeck 兼容，可直接安装使用。部分 CLI 特有功能（如 TUI 界面）在桌面端可能不适用。",
...
"config.emptyExtensions": "No installed extensions.",
  ...
  "config.recommendedPackagesHint": "These extensions are compatible with OmpDeck. Some CLI-specific features (e.g. TUI) may not apply in the desktop version.",
