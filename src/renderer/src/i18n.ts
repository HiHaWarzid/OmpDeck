...
"config.emptyExtensions": "暂无已安装扩展。",
  ...
  "settings.vision.section": "视觉桥",
  "settings.vision.enabled": "启用视觉桥",
  "settings.vision.enabledDesc": "发送图片消息时，先经视觉模型转成文本描述再注入上下文，让非视觉模型也能看图。图片仍会发送给 Agent，支持视觉的模型不受影响。",
  "settings.vision.baseUrl": "API 端点（OpenAI 兼容）",
  "settings.vision.baseUrlDesc": "例如 https://api.deepseek.com/v1，支持任何 OpenAI 兼容 chat completions 服务。",
  "settings.vision.apiKey": "API Key",
  "settings.vision.apiKeyDesc": "仅保存在本地 settings.json，用于视觉模型请求。",
  "settings.vision.model": "视觉模型 ID",
  "settings.vision.modelDesc": "该模型需要支持图片输入，例如 gpt-4o-mini、qwen-vl-max。",
  "settings.vision.prompt": "转换提示词",
  "settings.vision.promptDesc": "发送给视觉模型的描述指令；描述会作为补充上下文注入，不显示在聊天记录中。",
  "settings.vision.timeout": "转换超时（毫秒）",
  "settings.vision.timeoutDesc": "单张图片转换的最长等待时间，默认 120 秒。",
  "settings.vision.test": "测试连接",
  "settings.vision.testing": "测试中…",
  "settings.vision.testSuccess": "连接成功，可用模型：{models}",
  "settings.vision.testSuccessEmpty": "连接成功（端点未返回模型列表）",
  "settings.vision.presetPick": "从已配置模型中选择（视觉模型）",
  "settings.vision.presetDesc": "仅列出 models.json 中服务商 API 为 OpenAI 兼容、且模型勾选了图片输入的项；选中后自动填入端点 / API Key / 模型 ID。",
  "settings.vision.presetLoading": "正在读取已配置模型…",
  "settings.vision.presetEmpty": "暂未发现可复用的视觉模型：需要服务商 API 为 OpenAI 兼容且模型开启图片输入。可先到模型配置页添加，或直接在下方手动填写。",
  "settings.vision.presetLoadError": "读取已配置模型失败，可稍后重试，或直接在下方手动填写。",
  "settings.vision.customOption": "自定义（手动填写）",
  "settings.vision.capabilityYes": "模型目录确认该模型支持图片输入",
  "settings.vision.capabilityNo": "模型目录显示该模型不支持图片输入，已禁用",
  "settings.vision.capabilityUnchecked": "无法确认是否支持图片输入，请谨慎选择",
...
"config.emptyExtensions": "No installed extensions.",
  ...
  "settings.vision.enabledDesc": "When sending image messages, convert images to text descriptions via a vision model before injecting context, so non-vision models can see them. Images are still sent to the agent; vision-capable models are unaffected.",
  "settings.vision.baseUrl": "API endpoint (OpenAI-compatible)",
  "settings.vision.baseUrlDesc": "e.g. https://api.deepseek.com/v1; any OpenAI-compatible chat completions service works.",
  "settings.vision.apiKey": "API Key",
  "settings.vision.apiKeyDesc": "Stored locally in settings.json, used only for vision model requests.",
  "settings.vision.model": "Vision model ID",
  "settings.vision.modelDesc": "Must support image input, e.g. gpt-4o-mini, qwen-vl-max.",
  "settings.vision.prompt": "Conversion prompt",
  "settings.vision.promptDesc": "Instruction sent to the vision model; the description is injected as supplementary context, not shown in chat history.",
  "settings.vision.timeout": "Conversion timeout (ms)",
  "settings.vision.timeoutDesc": "Max wait per image, default 120 seconds.",
  "settings.vision.test": "Test connection",
  "settings.vision.testing": "Testing…",
  "settings.vision.testSuccess": "Connected. Available models: {models}",
  "settings.vision.testSuccessEmpty": "Connected (endpoint returned no model list)",
  "settings.vision.presetPick": "Pick a configured vision model",
  "settings.vision.presetDesc": "Lists models.json entries whose provider API is OpenAI-compatible and whose model has image input enabled. Selecting one fills in the endpoint / API key / model ID.",
  "settings.vision.presetLoading": "Loading configured models…",
  "settings.vision.presetEmpty": "No reusable vision model found: the provider API must be OpenAI-compatible and the model must have image input enabled. Add one in the models config, or fill the fields below manually.",
  "settings.vision.presetLoadError": "Failed to load configured models. Retry later, or fill the fields below manually.",
  "settings.vision.customOption": "Custom (fill in manually)",
  "settings.vision.capabilityYes": "Model catalog confirms this model supports image input",
  "settings.vision.capabilityNo": "Model catalog shows this model does not support image input; disabled",
  "settings.vision.capabilityUnchecked": "Cannot confirm image support; choose with care",
