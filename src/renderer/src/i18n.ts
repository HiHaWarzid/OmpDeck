...
"config.emptyExtensions": "暂无已安装扩展。",
  ...
  "settings.vision.presetPick": "从已配置模型中选择（已勾选图片输入）",
  "settings.vision.presetDesc": "仅列出 models.json 中服务商 API 为 OpenAI 兼容、且已在模型配置页勾选「图片输入」的模型；选中后自动填入端点 / API Key / 模型 ID。",
  "settings.vision.presetLoading": "正在读取已配置模型…",
  "settings.vision.presetEmpty": "暂未发现已勾选图片输入的 OpenAI 兼容模型。请到「模型配置」页为视觉模型勾选「图片输入」，或直接在下方手动填写。",
...
"config.emptyExtensions": "No installed extensions.",
  ...
  "settings.vision.presetPick": "Pick a configured vision model (image input checked)",
  "settings.vision.presetDesc": "Lists models.json entries whose provider API is OpenAI-compatible and whose model has the \"image input\" checkbox enabled in the models config. Selecting one fills in the endpoint / API key / model ID.",
  "settings.vision.presetLoading": "Loading configured models…",
  "settings.vision.presetEmpty": "No OpenAI-compatible model with image input enabled found. Enable \"image input\" for a vision model in the models config, or fill the fields below manually.",
